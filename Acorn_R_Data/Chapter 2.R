...
par(mfrow=c(2,2))
plot(num_vec_size ~ vec_length, 
     xlab = "Numeric seq vector", ylab = "Memory allocated (in bytes)", type = "n")
abline(h = (c(0,8,16,32,48,64,128)+40), col = "grey")
lines(num_vec_size, type = "S")
plot(char_vec_size ~ vec_length, 
     xlab = "Character seq vector", ylab = "Memory allocated (in bytes)", type = "n")
abline(h = (c(0,56,64,80,96,112,176)+40), col = "grey")
lines(char_vec_size, type = "S")
plot(log_vec_size ~ vec_length, 
     xlab = "Logical seq vector", ylab = "Memory allocated (in bytes)", type = "n")
abline(h = (c(0,8,16,32,48,64,128)+40), col = "grey")
lines(log_vec_size, type = "S")
plot(comp_vec_size ~ vec_length, 
     xlab = "Complex seq vector", ylab = "Memory allocated (in bytes)", type = "n")
abline(h = (c(0,56,64,80,96,112,176)+40), col = "grey")
